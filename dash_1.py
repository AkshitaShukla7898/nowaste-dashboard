...
def pi_chart(sel_val, column):
    ...
    fig.update_traces(text=dataframe['per_capita_waste'], textposition='inside', legendgrouptitle_text='Waste Type',
                      textinfo='percent+label+value+text')
